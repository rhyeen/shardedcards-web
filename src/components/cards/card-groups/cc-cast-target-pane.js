...
import { CancelCastTargetAbility } from '../../../actions/app.js';

import '../../global/cc-btn.js';

export class CcCastTargetPane extends LitElement {
  _render() {
    return html`
      ${CcSharedStyles}
      <style>
  ...
  _cancel() {
    store.dispatch(CancelCastTargetAbility())
  }
}

window.customElements.define('cc-cast-target-pane', CcCastTargetPane);
